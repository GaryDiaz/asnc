	...
	<div id="areaLlamadoConcurso">
		<div class="row">
			<div class="col-lg-12">
				...
				<fieldset class="border border-success p-10 shadow-lg">
					...
					<div class="row">
						<div class="form-group col-lg-12 col-md-12 col-sm-12">
							...
							<textarea class="form-control" id="txtDenominacionProceso" placeholder="Denominación del Proceso" require></textarea>
					...
					<div class="row">
						<div class="form-group col-lg-12 col-md-12 col-sm-12">
							...
							<textarea class="form-control" id="txtDescripcionContratacion" placeholder="Descripcion de Contratación" require></textarea>
				...
				<fieldset class="border border-success p-10 shadow-lg">
					<legend class="font-weight-bold">Observaciones</legend>
					<div class="row">
						<div class="form-group col-lg-12 col-md-12 col-sm-12">
							<label for="txtLugarEntrega">Observaciones</label>
